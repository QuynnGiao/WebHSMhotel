...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-Step mybagS slidePage">  
            ...
            <div class="col-md-12 text-center container bootdey">
        ...
        <style type="text/css">
            body{
                margin-top:10px;
                background:url(https://files.oyebesmartest.com/uploads/large/sea-of-stars-hd-wallpaper7ga9f.png) no-repeat; 

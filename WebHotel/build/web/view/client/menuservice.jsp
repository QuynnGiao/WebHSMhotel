                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="Service-Menu-content col-md-12">
                                                ...
                                                <!-- Room Service -->
                                                <div id="3-content" class="cont">
                                                    <div class="row">
                                                        <c:forEach items="${listS3}" var="s3">
                                                            <div class="col-md-6">
                                                                <div class="menu-info">
                                                                    <h5>${s3.sname} <span class="price">${s3.price}$</span></h5>
                                                                    <p>${s3.describle}
                                                                        <input type="submit" onclick="Buy('${s3.srid}')" value="Buy">                                                                        
                                                                    </p>
                                                                    <input class="numberS" type="number" name="quantity" min="1" max="20">
                                                                </div>
                                                            </div>
                                                ...
                                                <!-- Wine -->
                                                <div id="4-content" class="cont">
                                                    <div class="row">
                                                        <c:forEach items="${listS4}" var="s4">
                                                            <div class="col-md-6">
                                                                <div class="menu-info">
                                                                    <h5>${s4.sname} <span class="price">${s4.price}$</span></h5>
                                                                    <p>${s4.describle}
                                                                        <input type="submit" onclick="Buy('${s4.srid}')" value="Buy"> 
                                                                    </p>
                                                                    <input class="numberS" type="number" name="quantity" min="1" max="20">
                                                                </div>
                                                            </div>

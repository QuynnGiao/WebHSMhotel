...
public class Roomdetail {
    ...
    public Roomdetail(int rid, String urlimage1, String urlimage2, String urlimage3, String roomType, int peopleNumber, String rankofRoom, int bedNumber, double priceRoom, String describle) {
        this.rid = rid;
    ...
    public String toString() {
        return "Roomdetail{" + "rid=" + rid + ", urlimage1=" + urlimage1 + ", urlimage2=" + urlimage2 + ", urlimage3=" + urlimage3 + ", roomType=" + roomType + ", peopleNumber=" + peopleNumber + ", rankofRoom=" + rankofRoom + ", bedNumber=" + bedNumber + ", priceRoom=" + priceRoom + ", describle=" + describle + '}';
    }

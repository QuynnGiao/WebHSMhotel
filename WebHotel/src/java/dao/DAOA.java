...
public class DAOA {
    ...
    public Employees checkEmployees(String user) {
        String query = "select eid, urlimage, ename, birthofday, position, gender, eaddress, sdt,\n"
                + "cccd, salary, Employees.usid, QLusers.username, QLusers.passwork, QLusers.email, QLusers.urole\n"
    ...
    public List<user> getSC(String txtSearch) {
        ...
        String query = "select cid, urlimage, cname, birthofday, cccd, sdt,gender,caddress,country\n"
                + "                        ,Customer.usid, QLusers.username, QLusers.passwork, QLusers.email, QLusers.urole\n"
    ...
    public void UpdateR(int rid, String aimg, String bimg, String cimg, String roomtype, int Peoplenumber, int bednumber, String rankRoom, int priceroom, String status, String describle) {
        String query = "update Room set urlimage1 = ?, urlimage2 = ?, urlimage3 = ?, rtid = ?, peopleNumber = ?, \n"
                + "rankofRoom = ?, rstatus = ?, bedNumber= ?, priceRoom = ?, describle = ?\n"
                + "where rid = ?";
        try {
            conn = new DBConnect().getConnection();
            ps = conn.prepareStatement(query);
            ...
            ps.setInt(8, bednumber);
            ps.setInt(9, priceroom);
            ps.setString(10, describle);
            ps.setInt(11, rid);
            ps.executeUpdate();
        } catch (Exception e) {
        }
    ...
    public void UpdateS(int sid, String shimage, String name, String nametype, String status, float price, String describlie) {
        String query = "update Services set urlimage = ?, sname = ?, stid = ?, srstatus = ?, price = ?, describle = ?\n"
                + "where srid = ?";
        try {
            conn = new DBConnect().getConnection();
            ps = conn.prepareStatement(query);
    ...
    public void UDU(int usid, String user, String pass, String email, int role) {
        String query = " UPDATE QLusers set username = ?, passwork = ?, email = ?, urole = ?\n"
                + " where usid = ?";
        try {
            conn = new DBConnect().getConnection();
            ps = conn.prepareStatement(query);
    ...
    public List<BookR> getABR(int a) {
        ...
        String query = "select r.rid, r.urlimage1, r.rankofRoom, t.roomType, r.priceRoom,\n"
                + "o.datecheckin, o.datecheckout, DATEDIFF(day, o.datecheckin, o.datecheckout) * r.priceRoom, o.phid, DATEDIFF(day, o.datecheckin, o.datecheckout) as rdate\n"
                + "from BookRoom as o , Room as r, RoomType as t\n"
                + "where o.rid = r.rid and r.rtid = t.rtid and o.phid = ?";
        try {
            conn = new DBConnect().getConnection();
            ps = conn.prepareStatement(query);
            ps.setInt(1, a);
    ...
    public void UDBILL(int phid, int cid, int vid, String datePay, float total, String status) {
        String query = "update Bill set cid = ?, vid = ?, datePay = ?, totalmoney = ?, bstatus = ?\n"
                + "where phid = ?";
        try {
            conn = new DBConnect().getConnection();
            ps = conn.prepareStatement(query);
    ...
    public void UPP(String pas, String mail, int usid) {
        String query = "update QLusers set passwork = ?, email = ? where usid = ?";
        try {
            conn = new DBConnect().getConnection();
            ps = conn.prepareStatement(query);
            ps.setString(1, pas);

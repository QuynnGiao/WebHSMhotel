                        ...
                        <div class="card card-body border-0 shadow mb-4">
                            <form action="updateBill" method="POST">
                                <div class="row">
                                    ...
                                    <input name="id" class="form-control" id="first_name" type="text" value="${r.phid}" required hidden>
                                <input name="vid" class="form-control" id="first_name" type="text" value="${r.vid}" required hidden>
                                <div class="col-md-4 mb-3">
                                    <div>
                                        <label for="first_name">Customer</label>
                                        <img src="img/${r.cimg}" alt="" id="image" width="100" height="100">
                                        <input name="name" class="form-control" value="${r.cname}"  required readonly> 
                                        <input name="cid" class="form-control" value="${r.cid}"  required hidden> 
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <input name="phone" class="form-control" id="email" value="${r.sdt}" required readonly>
                                    </div>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <div>
                                        <label for="first_name">Date Pay Date</label>
                                        <input name="day" class="form-control" id="email" type=date" value="${r.paydate}" required readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="total">Totel price</label>
                                    <input class="form-control" name="total" type="text" value="${r.total}" required readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="gender">Status</label>
                                    <select name="status" class="form-select mb-0" id="status">
